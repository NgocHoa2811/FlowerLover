...
<body>
  ...
  <script>
    ...
    // Kiểm tra đăng nhập và xử lý gửi form
    document.getElementById('orderForm').addEventListener('submit', function(event) {
      ...
      if (!isLoggedIn) {
        ...
        Swal.fire({
          ...
          text: 'Bạn cần đăng nhập để gửi yêu cầu đặt hoa.',
          icon: 'warning',
    ...
    window.onload = function() {
      ...
      if (success === '1') {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            window.location.href = '<%= request.getContextPath() %>/delivery.jsp'; // Điều hướng tới delivery.jsp
          }
